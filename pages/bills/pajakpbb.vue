                    ...
                    <v-row>
                        <v-col cols="12">
                            ...
                            <v-select
                                ...
                                :items="years.reverse()"
                                label="Pilih Produk"
                                item-text="years.reverse()"
                                item-value="years.reverse()"
                                v-model="year"
                                dense
                            ></v-select>
                        </v-col>
            ...
            <div class="nominal mb-6">
                <v-col style="width: 100%">
                    <div class="payment-tagihan">
                        <v-btn 
                            color="#4f4f4f" 
                            class="pay-btn mt-5 white--text"
                            :loading="loading"
                            :disabled="loading" 
                            @click="loader = 'loading'"
                            style="padding: 20px 35px 20px 35px"
                        >Bayar
                        </v-btn>
                    </div>
                </v-col>
...
export default {
  ...
  data() {
    return {
      ...
      validating: [
        ...
        v => (v && v.length == 18) || 'Nomor Objek Pajak harus 18 karakter'
      ],
      items: [
        {
  ...
  computed: {
    years() {
      ...
      return Array.from({ length: year - 1989 }, (value, index) => 1990 + index)
    }
  }
}
</script>
