            ...
            <div class="nominal mb-6">
                <v-col style="width: 100%">
                    <div class="card" elevation="4">
                        ...
                        <v-card-text style="margin-top: -10px">1. Transaksi Produk Listrik PLN yang dilakukan pukul 23:40-00:45 akan mulai diproses pada pukul 00:45 WIB sesuai kebijakan pihak PLN</v-card-text>
  ...
  data() {
    return {
      ...
      validating: [
        ...
        v =>
          (v && v.length <= 12) || 'Nomor terlalu panjang, maksimum 12 karakter'
      ],
      items: [
        {
