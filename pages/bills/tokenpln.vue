        ...
        <main-header />
                    ...
                    <v-row>
                        <v-col cols="12">
                            <v-text-field
                                ...
                                type="number"
                                :rules="validating"
                                placeholder="Examples: 1122334455"
                            >
                                <template v-slot:prepend>
                                    ...
                                    >
                                        ...
                                        No. Meter atau Id Pelanggan adalah nomor yang tertera pada kartu pelanggan
                                    </v-tooltip>
                                </template>
                                <template v-slot:append>
                                    <v-fade-transition leave-absolute>
                                        <v-icon v-if="number.length >= 10">mdi-lightning-bolt</v-icon>
            ...
            <div class="nominal mb-6">
                <v-col style="width: 100%">
                    ...
                    <div class="mt-4 card" elevation="4">
                        <v-card-subtitle><b>Keterangan</b></v-card-subtitle>
                        <v-card-text style="margin-top: -10px">1. Transaksi Produk Listrik PLN yang dilakukan pukul 23:40-00.20 WIB akan mulai diproses pada pukul 00.20 WIB sesuai kebijakan pihak PLN</v-card-text>
                        <v-card-text style="margin-top: -30px">2. Proses verifikasi transaksi <b>maksimal 2x24 jam hari kerja</b></v-card-text>
                        <v-card-text style="margin-top: -30px">3. Harap cek <b>limit kWh</b> anda sebelum membeli token listrik</v-card-text>
                    </div>
                    <div class="payment">
  ...
  data() {
    return {
      ...
      validating: [
        ...
        v =>
          (v && v.length <= 14) || 'Nomor terlalu panjang, maksimum 14 karakter'
      ],
      topupData: [
        {
