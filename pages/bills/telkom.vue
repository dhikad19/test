                    ...
                    <v-row>
                        <v-col cols="12">
                            <v-text-field
                                ...
                                type="number"
                                :rules="validating"
                                placeholder="Examples: 021123456789"
                            >
                                <template v-slot:prepend>
                                    ...
                                    >
                                        ...
                                        Masukkan kode wilayah dan nomor telepon Anda
                                    </v-tooltip>
                                </template>
            ...
            <div class="nominal mb-6">
                <v-col style="width: 100%">
                    <div class="card" elevation="4">
                        ...
                        <v-card-text style="margin-top: -10px">1. Produk Telkom IndiHome/ Telepon tidak tersedia pada <b>jam cut off/maintenance (23.30 - 01.30)</b></v-card-text>
                        <v-card-text style="margin-top: -30px">2. Transaksi pembayaran tagihan Telkom Indihome/ Telepon membutuhkan waktu proses <b>maksimal 2x24 jam</b></v-card-text>
                    </div>
