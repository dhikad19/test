  ...
  <footer class="footer">
    <v-container>
      <v-row>
        ...
        >
          <div class="socmed">
            <a href="https://web.facebook.com/Jagaindotcom/" target="_blank">
            <v-btn
              text
              icon
              class="button"
            ...
            <a href="https://twitter.com/jagaindotcom" target="_blank">
            <v-btn
              text
              icon
              class="button"
            ...
            <a href="https://www.instagram.com/jagaindotcom" target="_blank">
            <v-btn
              text
              icon
              class="button"
            ...
            <a href="https://www.youtube.com/channel/UC2MQvIBT_BHaPif_yErNXaA/featured" target="_blank">
            <v-btn
              text
              icon
              class="button"
...
export default {
  ...
  data: () => ({
    ...
    footers: [
      {
        title: 'company',
        description: ['Blog', 'Karir', 'Promo', 'Tentang'],
        link: ['#', '#', '#', '#']
      },
      {
        title: 'resources',
      ...
      {
        title: 'contact',
        description: ['cs@jagain.com', '021-42883707 (Ext.429)'],
        link: ['mailto: cs@jagain.com', 'tel: 02142883707']
      }
    ]
  }),
  mounted() {
